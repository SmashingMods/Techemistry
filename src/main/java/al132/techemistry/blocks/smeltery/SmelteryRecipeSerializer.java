...
public class SmelteryRecipeSerializer<T extends SmelteryRecipe>
    ...
    public T fromJson(ResourceLocation recipeId, JsonObject json) {
        ...
        if (json.get("ingredient").isJsonArray()) {
            jsonelement = json.getAsJsonArray("ingredient");// JSONUtils.getJsonArray(json, "ingredient");
        } else {
            JsonObject jobj = json.getAsJsonObject("ingredient");//JSONUtils.getJsonObject(json, "ingredient");
        ...
        int minimumTemp = json.get("minimumTemp").getAsInt();//JSONUtils.getInt(json, "minimumTemp", this.temp);
    ...
    public void toNetwork(FriendlyByteBuf buffer, T recipe) {
        ...
        buffer.writeItem(recipe.gasOutput);
